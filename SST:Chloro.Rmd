...
chl_date_8 <- as.Date(Sys.time()) -5

chl_date_3 <- as.Date(Sys.time()) -3

chl_date_8 <- as.Date(chl_date_8) %>% 
  paste0("T12:00:00Z") 

chl_data_3 <- as.Date(chl_date_3) %>% 
  paste0("T12:00:00Z") 


url_8 <- paste0("https://coastwatch.pfeg.noaa.gov/erddap/griddap/erdMWchla8day_LonPM180.nc?chlorophyll%5B(", chl_date_8,")%5D%5B(0.0)%5D%5B(32.35):(34.75)%5D%5B(-121.4):(-117.06)%5D&.draw=surface&.vars=longitude%7Clatitude%7Cchlorophyll&.colorBar=%7C%7C%7C%7C%7C&.bgColor=0xffccccff")

url_3 <- paste0("https://coastwatch.pfeg.noaa.gov/erddap/griddap/erdMWchla3day_LonPM180.nc?chlorophyll%5B(", chl_date_8,")%5D%5B(0.0)%5D%5B(32.35):(34.75)%5D%5B(-121.4):(-117.06)%5D&.draw=surface&.vars=longitude%7Clatitude%7Cchlorophyll&.colorBar=%7C%7C%7C%7C%7C&.bgColor=0xffccccff")
...
ras_chl <- raster::merge(ras_chl_8, ras_chl_3)
